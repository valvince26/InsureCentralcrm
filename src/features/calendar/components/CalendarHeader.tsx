    ...
    <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 gap-4">
      ...
      <div className="flex items-center gap-4 bg-surface-container-lowest p-1.5 rounded-xl shadow-sm border border-outline-variant">
        ...
        <div className="flex items-center gap-2">
          <button className="p-1.5 hover:bg-surface-container-high rounded-md cursor-pointer">
            <span className="material-symbols-outlined text-[20px]">chevron_left</span>
          </button>
          <span className="text-label-md font-bold px-2">October 2023</span>
          <button className="p-1.5 hover:bg-surface-container-high rounded-md cursor-pointer">
            <span className="material-symbols-outlined text-[20px]">chevron_right</span>
          </button>
        </div>
        <button className="ml-4 bg-primary text-white px-5 py-2 rounded-lg text-label-md font-bold hover:bg-primary-container transition-colors shadow-sm flex items-center cursor-pointer hover:brightness-110">
